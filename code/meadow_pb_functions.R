## Copied from "pb_functions_for_manuscript.R" by James Meadow 
## https://github.com/jfmeadow/Meadow_HumanMicrobialCloud_Analysis/blob/master/manuscript_code/data/pb_functions_for_manuscript.R
