...
## custom color palette (http://www.r-bloggers.com/the-paul-tol-21-color-salute/)
# mycol.10 <- c("#332288", "#88CCEE", "#44AA99", "#117733", "#999933", 
...
Halomonas is abundant in both the controls and samples and causes a big jump in the cumulative sum. Shewanella is also consistently elevated in both controls along with 4 samples but is not one of the most abundant taxa overall.
```{r}
...
```{r}
pdf('~/Documents/projects/gerlinger/figures/contaminationTop10.pdf', height=10, width=10, useDingbats=TRUE)
